...
public class StringUtils {
  ...
  static {
    ...
    htmlEntities.put("&amp;","&")   ; htmlEntities.put("&quot;","\"");
    htmlEntities.put("&agrave;","ˆ"); htmlEntities.put("&Agrave;","Ë");
    htmlEntities.put("&acirc;","‰") ; htmlEntities.put("&auml;","Š");
    htmlEntities.put("&Auml;","€")  ; htmlEntities.put("&Acirc;","å");
    htmlEntities.put("&aring;","Œ") ; htmlEntities.put("&Aring;","?");
    htmlEntities.put("&aelig;","¾") ; htmlEntities.put("&AElig;","®" );
    htmlEntities.put("&ccedil;","?"); htmlEntities.put("&Ccedil;","‚");
    htmlEntities.put("&eacute;","Ž"); htmlEntities.put("&Eacute;","ƒ" );
    htmlEntities.put("&egrave;","?"); htmlEntities.put("&Egrave;","é");
    htmlEntities.put("&ecirc;","?") ; htmlEntities.put("&Ecirc;","æ");
    htmlEntities.put("&euml;","‘")  ; htmlEntities.put("&Euml;","è");
    htmlEntities.put("&iuml;","•")  ; htmlEntities.put("&Iuml;","ì");
    htmlEntities.put("&ocirc;","™") ; htmlEntities.put("&Ocirc;","ï");
    htmlEntities.put("&ouml;","š")  ; htmlEntities.put("&Ouml;","…");
    htmlEntities.put("&oslash;","¿") ; htmlEntities.put("&Oslash;","¯");
    htmlEntities.put("&szlig;","§") ; htmlEntities.put("&ugrave;","?");
    htmlEntities.put("&Ugrave;","ô"); htmlEntities.put("&ucirc;","ž");
    htmlEntities.put("&Ucirc;","ó") ; htmlEntities.put("&uuml;","Ÿ");
...
*/
  ...
  public static void main(String args[]) throws Exception {
      ...
      /*
         ...
         -->
         © 2007  RŽal Gagnon <www.rgagnon.com>
      */
  }
}